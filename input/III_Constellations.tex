...
\node[constellation-label] at (axis cs:{20,-8})  {\Huge \textls{Cetus}};
...
\node[constellation-label] at (axis cs:{101.5,25}) {\Large \textls{Gemini}};
\node[constellation-label] at (axis cs:{54,36})  {\Large \textls{Perseus}};
\node[constellation-label] at (axis cs:{102,-1.5}) {\Large \textls{Monoceros}};
...
\node[constellation-label] at (axis cs:{103,-19}) {\Large \textls{Canis}};
  \node[constellation-label] at (axis cs:{103,-22.5}) {\Large \textls{Major}};
