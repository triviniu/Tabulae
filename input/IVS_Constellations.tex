...
\
\node[constellation-label] at (axis cs:{118,3.5})  {\Large \textls{Canis}};
\node[constellation-label] at (axis cs:{116.5,7.5})  {\Large \textls{Minor}};

\node[constellation-label] at (axis cs:{105,-22})  {\Large \textls{Canis}};
\node[constellation-label] at (axis cs:{105,-18.5})  {\Large \textls{Major}};
