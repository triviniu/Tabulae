...
\tikzsetnextfilename{TabulaV}
%
% Coordinate limit of tab to plot
\pgfplotsset{xmin=180,xmax=290,ymin=-40,ymax=40}
...
% Constellations
\input{./input/V_Constellations.tex}

% Nebulae and nebulae names
\input{./input/V_Nebulae.tex}
%
% Stars and star names
\input{./input/V_Stars.tex}
\input{./input/V_Names.tex}
